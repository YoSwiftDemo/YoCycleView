...
@objc public protocol YoCycleViewProtocol: class {
    // 注册cell，[重用标志符：cell类]
    ...
    /// 开始拖拽
    @objc optional func cycleViewBeginDragingIndex(_ cycleView: YoCycleView, index: Int)
    /// 滚动到index
    @objc optional func cycleViewDidScrollToIndex(_ cycleView: YoCycleView, index: Int)
    /// 点击了index
    @objc optional func cycleViewDidSelectedIndex(_ cycleView: YoCycleView, index: Int)
    /// pageControl
    @objc optional func cycleViewConfigurePageControl(_ cycleView: YoCycleView, pageControl: YoPageControl)
}

public class YoCycleView: UIView {
    // 初始下标
    ...
    /// delegate
    public weak var delegate: YoCycleViewProtocol? {
        didSet {
    ...
    private lazy var flowLayout: YoCycleLayout = {
        let layout = YoCycleLayout()
    ...
    private lazy var pageControl: YoPageControl = {
        let pageControl = YoPageControl()
...
extension YoCycleView: UICollectionViewDelegate, UICollectionViewDataSource {
